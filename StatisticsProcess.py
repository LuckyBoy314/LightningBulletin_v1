...
地闪平均密度排第%d位（见表1-2）。'% (year,sum_region,density_region,day_region,
...
%s最低，为%.2f次/km2（见表1-1）。'%(sum_max_county,sum_max_region,sum_min_county,sum_min_region,
...
最高超过5次/km2。新昌东部有部分地区，地闪密度超过3次/km?，全市大部分地区地闪密度小于2次/km?。'
