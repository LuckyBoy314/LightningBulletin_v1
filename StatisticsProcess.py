...
p1 = u'%d年我市共发生地闪%d次，平均地闪密度%.2f次/km?，平均雷暴日%d天（见表1-1）。 \
     与上年的地闪%d次相比，%s[减幅较大]。从时间分布来看，地闪主要集中在%s[6、7、8]月，三个月地闪占全年总地闪次数的%.2f%。\
     从空间分布来看，%s发生地闪次数最多，%s最少。全市地闪平均密度%s[低于]全省平均的%.2f次/km?，在全省各市中绍兴地闪次数排第%s位，\
     地闪平均密度排第%s位（见表1-2）。'

p2 = u'据不完全统计，2016年全市因雷电引发的灾害共148起，无人员伤亡事故。造成直接经济损失达7788.04万元，间接经济损失677.42万元。'
p3= u'从地区统计来看，地区分布相对不均，诸暨地闪次数最多，共4788次，越城区最少，只有106次，两者分别占全市总地闪数的51.64%和1.14%。 \
    从平均密度统计来看，诸暨密度最高，为2.07次/km2，越城区最低，为0.21次/km2（见表1-1）。'
p4 = u'从地闪密度空间分布图上（见图1-1）可以看出，诸暨西北部、嵊州和诸暨交界区域地闪密度较高，最高超过5次/km2。\
     新昌东部有部分地区，地闪密度超过3次/km2，全市大部分地区地闪密度小于2次/km2。'
